...
const UPDATE_CAMERA_TRAP_BATCH_MUTATION = gql`
  mutation UpdateCameraTrapBatchMutation(
    $id: String!
...
export const Success = ({
  cameraTrapBatch,
}: CellSuccessProps<EditCameraTrapBatchById>) => {
  const [updateCameraTrapBatch, { loading, error }] = useMutation(
    UPDATE_CAMERA_TRAP_BATCH_MUTATION,
    {
      onCompleted: () => {
    ...
    <div className="rw-segment">
      <header className="rw-segment-header">
        <h2 className="rw-heading rw-heading-secondary">
          Edit CameraTrapBatch {cameraTrapBatch.id}
        </h2>
      </header>
